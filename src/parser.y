...
start:
  search_expression turnsto { searchExpressionDefinitions = $1->data.internal.definitions; } replacement_expression
  {
    if ($1->isLeaf())
    {
    ...
    // TODO: ensure that all placeholders in replacement expression are
    // defined in search expression
